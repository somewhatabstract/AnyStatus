...
namespace AnyStatus
{
    ...
    public class Theme
    {
        public static Theme Default = new Theme
        {
            Metadata = new[]
                    {
                        new StateMetadata(State.None, 0, "None", "Transparent", "NoneIcon"),
                        ...
                        new StateMetadata(State.PartiallySucceeded, 7, "Partially Succeeded", "Yellow", "PartiallySucceededIcon"),
                        new StateMetadata(State.Failed, 8, "Failed", "Red", "FailedIcon"),
                        new StateMetadata(State.Invalid, 9, "Invalid", "Orange", "WarningIcon"),
